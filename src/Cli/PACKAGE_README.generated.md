...
```json
{
"$schema": "https://raw.githubusercontent.com/agile-north/rexo/v/rexo.schema.json",
"schemaVersion": "1.0",
"name": "my-repo",
"commands": {
"build": {
...
| Configuration reference | <https://github.com/agile-north/rexo/blob/v/docs/CONFIGURATION.md> |
| Rexo config schema | <https://raw.githubusercontent.com/agile-north/rexo/v/rexo.schema.json> |
| Policy schema | <https://raw.githubusercontent.com/agile-north/rexo/v/policy.schema.json> |
| Architecture overview | <https://github.com/agile-north/rexo/blob/v/docs/ARCHITECTURE.md> |
| Contributing / dev guide | <https://github.com/agile-north/rexo/blob/v/docs/DEVELOPMENT.md> |
> **AI assistant tip**: `rx init --with-instructions` downloads
> [`rexo.instructions.md`](https://github.com/agile-north/rexo/blob/v/docs/rexo.instructions.md)
